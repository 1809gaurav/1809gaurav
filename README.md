...
<picture>
  ...
  <img alt="snake contribution graph" src="https://raw.githubusercontent.com/1809gaurav/1809gaurav/output/github-contribution-grid-snake.svg" />
</picture>

</div>

> ⚙️ **Setup note:** this snake animation is generated by a GitHub Action, not a static image. A ready-to-use workflow file is included at `.github/workflows/snake.yml` in this package — just push it to your `1809gaurav/1809gaurav` repo (Settings → Actions → allow workflow permissions → *Read and write*), and it will auto-render and update the SVG above on every push.
